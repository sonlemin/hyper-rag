...
| R2 | Trích xuất n-ngôi tiếng Việt kém | Cao | Đường lùi hai bậc, đã chốt trước: bậc 1 - precision bộ vàng dưới 60% ở T2 thì chuyển GPT-4o toàn phần + tăng few-shot; bậc 2 - GPT-4o vẫn dưới ngưỡng thì rút lược đồ về 5 vai (chủ thể, triệu chứng, điều kiện, nguyên nhân + hành động gộp, người phụ trách), bỏ vai nguồn (provenance đã có `source_id`) và vai thời điểm (chỉ phục vụ tính năng lỗi thời, vốn là COULD). Vai điều kiện giữ đến cùng vì N3 và ĐG4 đứng trên nó |
...
| T2 | Lược đồ 8 vai đầy đủ, prompt trích xuất tiếng Việt, bộ vàng 30 câu + nhãn truy hồi vàng, corpus ~40 tài liệu (dựng với ít nhất 2 khách hàng để RT-01 thử được ở T3); đo 3 chỉ số n-ngôi + CT-03 trên 50 bản ghi; phần chính spike R1; viết chương 1-2. Chốt cứng: phương pháp luận (existence proof, 3 phép đo) phải được GVHD xác nhận chậm nhất cuối T2; sau đó phản hồi GVHD chỉ correct-course phần trình bày, không đổi khung đo | |
